<div class="container-fluid">
    ...
    <div class="row text-center mt-4">
        ...
        <?php foreach ($jml_brg as $brg) : ?>

            <div class="col-md-3">
                <div class="card mb-3 shadow-lg p-1 bg-body rounded lol">
                    <img src="<?php echo base_url() . '/uploads/' . $brg['gambar']; ?>" class="card-img-top" alt="bunga" style="width: 246px; height: 164px; object-fit:cover ; border: 1px outset #00FFAB;">
                    <div class="card-body">
                        <h6 class="card-title"><?php echo $brg['nama_barang']; ?></h6>
